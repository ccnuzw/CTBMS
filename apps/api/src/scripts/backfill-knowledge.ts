...
async function syncIntel(intelId: string) {
  ...
  await prisma.knowledgeAnalysis.upsert({
    ...
    create: {
      ...
      keyPoints: ai.keyPoints as any,
      prediction: ai.prediction as any,
      dataPoints: ai.dataPoints as any,
      events: ai.events as any,
      insights: ai.insights as any,
      marketSentiment: ai.marketSentiment as any,
      traceLogs: ai.traceLogs as any,
      tags: ai.tags || [],
    },
    update: {
      summary: ai.summary || intel.summary,
...
async function syncReport(reportId: string) {
  ...
  await prisma.knowledgeAnalysis.upsert({
    ...
    create: {
      ...
      keyPoints: report.keyPoints as any,
      prediction: report.prediction as any,
      dataPoints: report.dataPoints as any,
