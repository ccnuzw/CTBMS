        ...
        items: [
            {
                ...
                label: '采集任务',
                sortOrder: 10,
                meta: { formKey: 'collection-form', workflowKey: 'default-approval', requiresCollectionPoint: true, defaultSlaHours: 24 },
            },
            {
                code: 'REPORT',
                label: '报告任务',
                sortOrder: 20,
                meta: { formKey: 'report-form', workflowKey: 'default-approval', requiresCollectionPoint: false, defaultSlaHours: 48 },
            },
            {
                code: 'RESEARCH',
                label: '调研任务',
                sortOrder: 30,
                meta: { formKey: 'research-form', workflowKey: 'research-approval', requiresCollectionPoint: false, defaultSlaHours: 72 },
            },
            {
                code: 'VERIFICATION',
                label: '核实任务',
                sortOrder: 40,
                meta: { formKey: 'verification-form', workflowKey: 'fast-approval', requiresCollectionPoint: false, defaultSlaHours: 12 },
            },
            {
                code: 'OTHER',
                label: '其他',
                sortOrder: 50,
                meta: { formKey: 'generic-form', workflowKey: 'default-approval', requiresCollectionPoint: false, defaultSlaHours: 24 },
            },
        ],
    },
    {
