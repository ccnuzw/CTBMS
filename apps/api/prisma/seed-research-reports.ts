import { PrismaClient, ReportType, ReportPeriod, ReviewStatus, ContentType, IntelSourceType, IntelCategory, KnowledgeType, KnowledgeStatus, KnowledgePeriodType } from '@prisma/client';

const prisma = new PrismaClient();

async function main() {
    console.log('🌱 开始播种研报测试数据 (Grain Focus, 20 items)...');
...
供应洪峰即将到来，短期价格承压。
            ...
            viewCount: 156, downloadCount: 23
        },
        {
            ...
            source: '粮油中心',
            summary: '今年东北玉米单产明显提升，但由于收割期雨水偏多，部分地区霉变率略高于往年，优质粮源相对稀缺。',
            content: `
# 东北产区新粮上市进度与质量分析
今年的玉米丰产已成定局，均亩产提升约 100斤。但受前期降雨影响，**水分偏高**，储存难度大。
            ...
            prediction: { direction: 'MIXED', timeframe: 'MEDIUM', logic: '量增质降，优质粮将有溢价。' },
            dataPoints: [{ metric: '平均水分', value: '28', unit: '%' }],
            commodities: ['CORN'],
            regions: ['东北'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 210, downloadCount: 45
        },
        {
            ...
            source: '我的农产品网',
            summary: '华北深加工企业厂门到货量维持高位，库存普遍回升至15天以上。由于下游淀粉利润微薄，压价收购意愿较强。',
            content: `
# 华北玉米深加工企业调研
企业库存快速回升，厂家**压价意愿强烈**。淀粉亏损幅度扩大，开工率有下调风险。
            ...
            regions: ['华北'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 180, downloadCount: 30
        },
        {
            ...
            source: '农业部',
            summary: '预计2025/26年度国内玉米产量2.93亿吨，消费量2.98亿吨，产需缺口收窄。进口替代品（大麦、高粱）到港量预计维持高位。',
            content: `
# 2025/26年度玉米供需平衡表
产需缺口收窄，**进口替代品**对国内玉米价格形成天花板效应。
            ...
            regions: ['全国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 450, downloadCount: 120
        },
        {
            ...
            source: '锦州港',
            summary: '锦州港新粮集港量3万吨，主流平舱价2560元/吨，较昨日持平。下海量有所增加，南方饲企补库积极性一般。',
            content: `
# 港口玉米价格日报
集港量依然在高位，价格企稳。南方饲料厂采购**按需即采**，未见大规模囤货。
            `,
            keyPoints: [
                { point: '价格企稳', sentiment: 'NEUTRAL', confidence: 95 }
            ],
        ...
        },
        {
            ...
            source: '中粮期货',
            summary: '美玉米收割完毕，产量创历史次高。CBOT玉米主力合约跌破450美分。进口玉米完税成本估算在2100元/吨左右，远低于国内现货价格。',
            content: `
# CBOT玉米与进口成本
内外价差依然巨大，**进口利润丰厚**。关注后期配额发放及转基因玉米进口政策。
            ...
            regions: ['全球', '美国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 320, downloadCount: 60
        },
        {
            ...
            source: '粮食局',
            summary: '主要基调是“保供稳价”，强调多元主体入市，避免出现“卖粮难”。增储计划将根据市场价格动态调整。',
            content: `
# 秋粮收购政策解读
政策托底意愿明确，但**不进行强刺激**。旨在平滑市场波动。
            `,
            keyPoints: [
                { point: '保供稳价，防止卖粮难', sentiment: 'STABLE', confidence: 100 }
            ],
            ...
            regions: ['全国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 120, downloadCount: 10
        },
        {
            ...
            source: '气象局',
            summary: '阿根廷玉米核心产区遭遇旱情，播种进度滞后。巴西首季玉米长势尚可。若干旱持续，南美总产存在下调风险。',
            content: `
# 拉尼娜影响评估
阿根廷干旱风险升温，市场开始交易**天气升水**。关注1月底关键降雨。
            `,
            keyPoints: [
                { point: '阿根廷产区干旱', sentiment: 'BULLISH', confidence: 80 }
            ],
            ...
            regions: ['南美'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 280, downloadCount: 55
        },
        {
            ...
            source: '饲料协会',
            summary: '由于玉米价格回落，饲料企业开始调增玉米在配方中的比例，小麦和高粱的替代优势减弱。',
            content: `
# 饲料配方主要变化
玉米性价比回归，**配方占比回升**至 40%-50%。替代品退出。
            `,
            keyPoints: [
                { point: '玉米配方占比提升', sentiment: 'BULLISH', confidence: 85 }
            ],
            ...
            regions: ['全国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 160, downloadCount: 22
        },
        {
            title: '临储玉米拍卖成交结果分析',
            reportType: ReportType.MARKET,
            ...
            source: '交易中心',
            summary: '本周投放陈稻化谷和定向玉米共计200万吨，成交率依然低迷（15%）。市场陈粮供应充足，新粮上行有顶。',
            content: `
# 临储拍卖结果
成交清淡，市场**不缺粮**。陈粮出库即面临亏损。
            `,
            keyPoints: [
                { point: '成交率低迷', sentiment: 'BEARISH', confidence: 95 }
            ],
            ...
            regions: ['东北'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 300, downloadCount: 40
        },
        ...
        // --- 小麦 (WHEAT) 4篇 ---
        {
            ...
            source: '粮油中心',
            summary: '截至10月底，全国冬小麦播种进度已过八成。黄淮海地区墒情适宜，出苗情况良好。',
            content: `
# 冬小麦播种监测
播种顺利，苗情**一类苗比例高**。明年丰产基础好。
        ...
        },
        {
            ...
            publishDate: new Date('2025-12-01'),
            source: '中华粮网',
            summary: '面粉消费进入旺季，制粉企业开机率提升，小麦收购积极性提高，价格普涨0.01-0.02元/斤。',
            content: `
# 制粉企业收购周报
旺季效应显现，**价格坚挺**。企业积极备货过节。
            `,
            keyPoints: [
                { point: '价格普涨', sentiment: 'BULLISH', confidence: 90 }
            ],
            ...
            regions: ['河北', '山东'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 110, downloadCount: 15
        },
        {
            ...
            source: '发改委',
            summary: '发改委公布2026年生产的小麦（三等）最低收购价为1.19元/斤，较上年持平。政策信号明确：稳口粮不仅是稳面积，也是稳价格预期。',
            content: `
# 最低收购价政策公布
价格**持平**，符合市场预期。主要是为了稳定种植收益，保障口粮安全。
            `,
            keyPoints: [
                { point: '最低收购价持平', sentiment: 'NEUTRAL', confidence: 100 }
            ],
            ...
            regions: ['全国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 300, downloadCount: 50
        },
        {
            ...
            source: '交易中心',
            summary: '本周投放最低收购价小麦100万吨，成交率25%，成交均价2450元/吨。饲用替代优势丧失，主要是面粉厂参拍。',
            content: `
# 政策粮拍卖周报
饲用需求退出，仅剩**刚需制粉**采购，成交一般。
            `,
            keyPoints: [
                { point: '成交率25%', sentiment: 'NEUTRAL', confidence: 90 }
            ],
        ...
        // --- 稻谷 (RICE) 3篇 ---
        {
            ...
            source: '中国稻米网',
            summary: '江西、湖南中晚籼稻集中上市，米企入市积极。受托市启动预期支撑，价格表现坚挺，部分地区高于托市价。',
            content: `
# 中晚籼稻上市快报
价格**稳中偏强**，优质优价明显。托市政策托底作用强。
            `,
            keyPoints: [
                { point: '价格坚挺', sentiment: 'BULLISH', confidence: 85 }
            ],
            ...
            regions: ['南方', '江西'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 130, downloadCount: 10
        },
        {
            title: '2025年全国稻谷产量预测',
            reportType: ReportType.INDUSTRY,
            ...
            source: '统计局',
            summary: '预计2025年全国稻谷总产量2.08亿吨，同比略减。主要是由于南方双季稻种植面积小幅下降，但单产保持稳定。',
            content: `
# 稻谷产量预测
总产**微减**，口粮绝对安全。结构性矛盾依然存在（籼强粳弱）。
            `,
            keyPoints: [
                { point: '产量微降', sentiment: 'NEUTRAL', confidence: 95 }
            ],
            ...
            regions: ['全国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 210, downloadCount: 25
        },
        {
            ...
            source: '海关总署',
            summary: '印度放松大米出口限制，国际米价回落。由于国内外价差缩小，预计2026年一季度大米进口量将有所减少。',
            content: `
# 国际米价影响分析
国际价格回落，**进口优势减弱**。利好国内稻谷去库存。
            `,
            keyPoints: [
                { point: '进口优势减弱', sentiment: 'BULLISH', confidence: 80 }
            ],
            ...
            regions: ['全球', '亚洲'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 305, downloadCount: 45
        },
...
到港量大，**库存累积**。压榨利润缩水。
            ...
            regions: ['沿海'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 405, downloadCount: 98
        },
        {
            title: '豆粕现货基差走势分析',
            reportType: ReportType.MARKET,
            ...
            source: '天下粮仓',
            summary: '华东地区豆粕基差持续走弱，现货价格跌破3000元/吨关口。饲料厂节前备货基本结束，成交清淡。',
            content: `
# 豆粕基差分析
基差**走弱**，现货价格承压。节前备货已接近尾声。
            `,
            keyPoints: [
                { point: '基差走弱', sentiment: 'BEARISH', confidence: 90 }
            ],
            ...
            regions: ['华东'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 155, downloadCount: 10
        },
        {
            title: '美豆出口销售数据解读',
            reportType: ReportType.MARKET,
            ...
            source: 'USDA',
            summary: 'USDA最新数据显示，美豆周度出口销售净增80万吨，符合预期。中国依然是最大买家，由于巴西大豆即将上市，美豆销售窗口期即将关闭。',
            content: `
# USDA 出口销售报告
销售数据中规中矩，窗口期**即将关闭**。市场焦点转向南美天气。
            `,
            keyPoints: [
                { point: '销售符合预期', sentiment: 'NEUTRAL', confidence: 85 }
            ],
            ...
            regions: ['美国'],
            reviewStatus: ReviewStatus.APPROVED,
            viewCount: 220, downloadCount: 18
        }
    ];

    for (const reportData of reports) {
        // 先创建 MarketIntel
        // 注意：这里使用 content (Markdown) 作为 rawContent
        const intel = await prisma.marketIntel.create({
            data: {
                rawContent: reportData.content,
        ...
        const report = await prisma.researchReport.create({
            data: {
                ...
                summary: reportData.summary, // Short summary
        ...
        // [FIX] 同步创建 KnowledgeItem (模拟 KnowledgeService.syncFromResearchReport)
        ...
        console.log(`   ✅ 创建研报 & 知识条目: ${reportData.title}`);
    }

    console.log(`\n✅ 成功创建 ${reports.length} 条研报测试数据 (Markdown版)`);
}

// Helper Functions (copied from KnowledgeService)
