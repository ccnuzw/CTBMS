...
export const MainLayout: React.FC = () => {
  ...
  const getPageTitle = () => {
    const found =
      findMenuLabel(mainMenuItems, location.pathname) ||
      findMenuLabel(bottomMenuItems, location.pathname);
      ...
      <Layout style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <Title level={4} style={{ margin: 0, fontSize: isMobile ? '16px' : undefined }}>
              {getPageTitle()}
            </Title>
          </div>
