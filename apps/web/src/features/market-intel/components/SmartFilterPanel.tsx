...
import { Card, Flex, Select, DatePicker, Tag, Segmented, Button, Space, Divider, Typography } from 'antd';
import { FilterOutlined, CalendarOutlined, GlobalOutlined, AppstoreOutlined, ClearOutlined } from '@ant-design/icons';
            ...
            <Flex vertical gap={16}>
                ...
                <Flex gap={24} wrap="wrap">
                    ...
                    <Space direction="vertical" size={2}>
                        <Text type="secondary" style={{ fontSize: 12 }}>关注品种</Text>
                        <Select
                            mode="multiple"
                            placeholder="全品种"
                    ...
                    {/* 区域筛选 */}
                    <Space direction="vertical" size={2}>
                        <Text type="secondary" style={{ fontSize: 12 }}> <GlobalOutlined /> 区域维度</Text>
                        <Select
                            mode="multiple"
                            placeholder="全区域"
                            style={{ minWidth: 160, maxWidth: 300 }}
                    ...
                    {/* 事件类型筛选 */}
                    <Space direction="vertical" size={2}>
                        <Text type="secondary" style={{ fontSize: 12 }}> <AppstoreOutlined /> 事件类型的</Text>
                        <Select
                            mode="multiple"
                            placeholder="全类型"
                            style={{ minWidth: 160, maxWidth: 300 }}
