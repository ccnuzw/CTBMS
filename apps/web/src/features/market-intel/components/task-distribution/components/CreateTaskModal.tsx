...
export const CreateTaskModal: React.FC<CreateTaskModalProps> = ({ open, onCancel, onCreate, onGoTemplates }) => {
    ...
    const { data: collectionPointsResult, isLoading: pointsLoading } = useCollectionPoints({ page: 1, pageSize: 1000, isActive: true });
    const collectionPointOptions = (collectionPointsResult?.data || []).map(point => ({
        ...
        >
            <div ref={containerRef}>
                ...
                <ProFormSelect
                    ...
                    colProps={{ span: 8 }}
                />
                {taskType === IntelTaskType.COLLECTION && (
                    <ProFormSelect
                        ...
                        fieldProps={{ showSearch: true, optionFilterProp: 'label', loading: pointsLoading }}
                        colProps={{ span: 8 }}
                    />
                )}
                <ProFormDatePicker
