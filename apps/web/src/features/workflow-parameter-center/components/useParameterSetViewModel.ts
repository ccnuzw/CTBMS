...
export function useParameterSetViewModel() {
  ...
  const [scopeResetLevel, setScopeResetLevel] = useState<ParameterScopeLevel | undefined>(
    undefined,
  );
  ...
  const handleCreateItem = async () => {
    ...
    try {
      ...
      let finalUiProps = parseMaybeJsonText((values as any).uiPropsText) as
        | Record<string, unknown>
        | undefined;
      if (values.paramType === 'number') {
        if (values.numberStep !== undefined) {
          finalUiProps = finalUiProps || {};
          finalUiProps.step = values.numberStep;
        }
      } else if (values.paramType === 'enum' || values.paramType === 'string') {
        if (values.selectOptions && values.selectOptions.length > 0) {
          finalUiProps = finalUiProps || {};
          finalUiProps.options = values.selectOptions;
        }
      }
      ...
      const payload: CreateParameterItemDto = {
        ...
        minValue: values.numberMin !== undefined ? values.numberMin : undefined,
        maxValue: values.numberMax !== undefined ? values.numberMax : undefined,
  ...
  const openEditItem = (record: ParameterItemDto) => {
    ...
    editItemForm.setFieldsValue({
      ...
      uiComponent: record.uiComponent || undefined,
      optionsSourceId: record.optionsSourceId || undefined,
      uiPropsText:
        record.uiProps === null || record.uiProps === undefined
          ? ''
          : JSON.stringify(record.uiProps, null, 2),
      unit: record.unit || undefined,
      source: record.source || undefined,
      isActive: record.isActive,
      numberMin: typeof record.minValue === 'number' ? record.minValue : undefined,
      numberMax: typeof record.maxValue === 'number' ? record.maxValue : undefined,
      numberStep:
        typeof (record.uiProps as any)?.step === 'number'
          ? (record.uiProps as any).step
          : undefined,
      selectOptions: Array.isArray((record.uiProps as any)?.options)
        ? (record.uiProps as any).options
        : undefined,
    });
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      ...
      let finalUiProps = parseMaybeJsonText(values.uiPropsText) as
        | Record<string, unknown>
        | undefined;
      if (values.paramType === 'number') {
        if (values.numberStep !== undefined) {
      ...
      const payload: UpdateParameterItemDto = {
        ...
        minValue:
          values.numberMin !== undefined
            ? values.numberMin
            : parseMaybeJsonText(values.minValueText),
        maxValue:
          values.numberMax !== undefined
            ? values.numberMax
            : parseMaybeJsonText(values.maxValueText),
        uiComponent: values.uiComponent,
        optionsSourceId: values.optionsSourceId,
        uiProps: finalUiProps,
        unit: values.unit,
