    ...
    <div style={{ display: 'flex', gap: 16, flexDirection: 'column' }}>
      ...
      >
        ...
        <Flex justify="space-between" align="center">
          ...
          {testResults.length > 0 && <Tag color="green">{testResults.length} 条匹配结果</Tag>}
        </Flex>
              ...
              >
                ...
                {result.extractedData && (
                  <Flex gap={8}>
                    ...
                    {result.extractedData.action && <Tag>动作: {result.extractedData.action}</Tag>}
                  </Flex>
                )}
              </Card>
            ))}
