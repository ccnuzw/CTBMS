...
export const ParameterItemSchema = z.object({
  ...
  uiProps: z.record(z.unknown()).nullable().optional(),
  optionsSourceId: z.string().nullable().optional(),
...
export const CreateParameterItemSchema = z.object({
  ...
  uiComponent: z.string().max(120).optional(),
  uiProps: z.record(z.unknown()).optional(),
  optionsSourceId: z.string().max(120).optional(),
  scopeLevel: ParameterScopeLevelEnum,
