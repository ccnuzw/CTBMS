...
| 检查项 | 状态 | 耗时(秒) |
| --- | --- | --- |
| `pnpm workflow:type-check:split` | PASS | 64.02 |
| `pnpm --filter api run test:e2e:agent-suite` | PASS | 232.17 |

### pnpm workflow:type-check:split

- 状态: PASS
- 开始: 2026-02-25T17:22:59.949Z
- 结束: 2026-02-25T17:24:03.965Z
...
- 状态: PASS
- 开始: 2026-02-25T17:24:03.965Z
- 结束: 2026-02-25T17:27:56.132Z
