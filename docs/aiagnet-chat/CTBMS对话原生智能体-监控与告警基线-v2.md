...
| 检查项 | 状态 | 耗时(秒) |
| --- | --- | --- |
| `pnpm workflow:type-check:split` | PASS | 77.01 |
| `pnpm --filter api run test:e2e:agent-suite` | PASS | 423.26 |

### pnpm workflow:type-check:split

- 状态: PASS
- 开始: 2026-02-26T15:51:18.876Z
- 结束: 2026-02-26T15:52:35.884Z
...
- 状态: PASS
- 开始: 2026-02-26T15:52:35.884Z
- 结束: 2026-02-26T15:59:39.140Z
